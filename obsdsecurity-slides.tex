...
\path
    ...
    (gap.south) node [draw,fill=yellow!60,minimum height=0.8cm] (frame) {frame}
    (frame.south) node [draw,fill=red] (pointer2) {pointer}
...
\path
    [text width=3cm,below,align=left]
    (5,0) node [draw,minimum height=6cm] (text) {}
