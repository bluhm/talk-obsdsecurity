...
\begin{alltt}
40d435: {\color{red}cc}           int3
40d436: {\color{red}cc}           int3
......
40d43e: {\color{red}cc}           int3
40d43f: {\color{red}cc}           int3
40d440: 55           push %rbp
...
\end{itemize}
\begin{alltt}
4022ff: 48 83 c0 {\color{blue}08}  add  $0x8,%rax
402303: {\color{blue}48 39} {\color{red}c3}     cmp  %rax,%rbx
...
\end{itemize}
\begin{alltt}
402302: {\color{blue}08 48 39}     or   %cl,0x39(%rax)
402305: {\color{red}c3}           retq
\end{alltt}
\end{frame}
