...
\draw
    ...
    +(0,-3.2) node [draw,minimum width=2cm,fill=blue] {lib1}
    +(0,-4.7) node [draw,minimum width=2cm,fill=yellow] {lib2}
...
\draw
    ...
    +(0,-3.3) node [draw,minimum width=2cm,fill=yellow] {lib2}
    +(0,-4.1) node [draw,minimum width=2cm,fill=blue] {lib1}
